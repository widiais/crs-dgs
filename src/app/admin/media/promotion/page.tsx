      ...
      <div className="sticky top-0 z-30 bg-white border-b shadow-sm">
        <div className="p-6">
          ...
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-bold">Promotion Media</h1>
              <p className="text-gray-600">Manage Promotion media files with drag and drop</p>
        ...
        >
          <div className="text-center">
            ...
            <h3 className="text-xl font-medium mb-2">
              {dragOver ? 'Drop Promotion files here' : 'Upload Promotion Media'}
            </h3>
        ...
        {media.length > 0 ? (
          ...
          <Card>
            <CardContent className="p-12 text-center">
              ...
              <h3 className="text-xl font-medium mb-2">No Promotion Media</h3>
              <p className="text-gray-500 mb-4">
                Start by uploading your first Promotion media file using drag and drop or click to browse.
              </p>
            ...
            <div className="p-4 border-b flex justify-between items-center">
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Promotion • {previewMedia.duration}s • {previewMedia.type.toUpperCase()}
                </p>
              </div>
              <Button
                variant="ghost"
