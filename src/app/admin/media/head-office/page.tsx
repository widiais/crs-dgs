...
export default function HeadOfficeMediaPage() {
  const { user } = useAuth();
      ...
      <div className="sticky top-0 z-30 bg-white border-b shadow-sm">
        <div className="p-6">
          ...
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-bold">Head Office Media</h1>
              <p className="text-gray-600">Manage Head Office media files with drag and drop</p>
        ...
        >
          <div className="text-center">
            ...
            <h3 className="text-xl font-medium mb-2">
              {dragOver ? 'Drop Head Office files here' : 'Upload Head Office Media'}
            </h3>
        ...
        {media.length > 0 ? (
          ...
          <Card>
            <CardContent className="p-12 text-center">
              ...
              <h3 className="text-xl font-medium mb-2">No Head Office Media</h3>
              <p className="text-gray-500 mb-4">
                Start by uploading your first Head Office media file using drag and drop or click to browse.
              </p>
            ...
            <div className="p-4 border-b flex justify-between items-center">
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Head Office • {previewMedia.duration}s • {previewMedia.type.toUpperCase()}
                </p>
              </div>
              <Button
                variant="ghost"
